...
- **[Bounty Submission: Building Decentralized Identity (DIDs) with Midnight](bounty-submissions/issue-228-building-decentralized-identity-dids-with-midnight.md):** Submitted tutorial and companion code for issue #228.
